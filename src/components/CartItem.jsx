        ...
        <div className="cart__item">
            <div className="cart__item-img">
                <img
                    ...
                    src="https://icons-for-free.com/iconfiles/png/512/buy+cart+online+shopping+shop+shopping+shopping+basket+icon-1320191078019322255.png"
                    alt="Pizza"
                />
            </div>
            ...
            <div onClick={handleMinusItem} className="cart__item-remove">
