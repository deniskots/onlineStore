...
function Cart() {
    ...
    //обращаемся к редаксу что бы взять все состояние карзины
    const {totalPrice, totalCount, items} = useSelector(({cart}) => cart);

    //возращает масив ключей и от туда доставать по одному обьекту через мэп
            ...
            <div className="container container--cart">
                {
                    totalCount ? <div className="cart">
                        ...
                        <p>
                            Вероятней всего, вы не заказывали ещё товар.<br/>
